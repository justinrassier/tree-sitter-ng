...
extern "C" {
#endif
void *tree_sitter_ng_external_scanner_create(void);
void tree_sitter_ng_external_scanner_destroy(void *);
bool tree_sitter_ng_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_ng_external_scanner_serialize(void *, char *);
void tree_sitter_ng_external_scanner_deserialize(void *, const char *, unsigned);

#ifdef _WIN32
#define extern __declspec(dllexport)
#endif

extern const TSLanguage *tree_sitter_ng(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_ng_external_scanner_create,
      tree_sitter_ng_external_scanner_destroy,
      tree_sitter_ng_external_scanner_scan,
      tree_sitter_ng_external_scanner_serialize,
      tree_sitter_ng_external_scanner_deserialize,
    },
